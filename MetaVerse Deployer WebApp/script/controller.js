...
$("#pg-data").hide();
let indx=0;
let themes = [{imgurl:"/images/theme1.jpeg",id:"genesis"}/*,{imgurl:"/images/t1.jpg",id:"t2"}*/];
...
$( "#gogo" ).click(async function() {
    ...
    try{
        ...
        $("#contract_addr").children("a").attr("href",`https://scan-warringstakes.meter.io/address/${contract_addr}`)
